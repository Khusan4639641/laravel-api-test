...
class StatusService
{
    ...
    private const STATUS_TRANSLATIONS = [
        'manager' => [
            'name' => ['ru' => 'Менеджер', 'kk' => 'Менеджер', 'ky' => 'Менеджер', 'en' => 'Manager', 'mn' => 'Менежер'],
            'reward' => ['ru' => '2 продукта в подарок', 'kk' => 'Сыйлыққа 2 өнім', 'ky' => 'Белекке 2 өнүм', 'en' => '2 products as a gift', 'mn' => 'Бэлгэнд 2 бүтээгдэхүүн'],
        ],
        'leader' => [
            'name' => ['ru' => 'Лидер', 'kk' => 'Лидер', 'ky' => 'Лидер', 'en' => 'Leader', 'mn' => 'Лидер'],
            'reward' => ['ru' => 'Набор косметики', 'kk' => 'Косметика жиынтығы', 'ky' => 'Косметика топтому', 'en' => 'Cosmetics set', 'mn' => 'Гоо сайхны багц'],
        ],
        'director' => [
            'name' => ['ru' => 'Директор', 'kk' => 'Директор', 'ky' => 'Директор', 'en' => 'Director', 'mn' => 'Директор'],
            'reward' => ['ru' => '250 000 ₸ cash bonus', 'kk' => '250 000 ₸ ақшалай бонус', 'ky' => '250 000 ₸ акчалай бонус', 'en' => '250,000 ₸ cash bonus', 'mn' => '250 000 ₸ мөнгөн бонус'],
        ],
        'bronze_director' => [
            'name' => ['ru' => 'Бронзовый директор', 'kk' => 'Қола директор', 'ky' => 'Коло директор', 'en' => 'Bronze Director', 'mn' => 'Хүрэл директор'],
            'reward' => ['ru' => 'Путевка в санаторий + 100 000 ₸, при отказе 400 000 ₸', 'kk' => 'Санаторий жолдамасы + 100 000 ₸, бас тартса 400 000 ₸ өтемақы', 'ky' => 'Санаторийге жолдомо + 100 000 ₸, баш тартса 400 000 ₸ компенсация', 'en' => 'Sanatorium trip + 100,000 ₸, 400,000 ₸ compensation if refused', 'mn' => 'Сувиллын эрх + 100 000 ₸, татгалзвал 400 000 ₸ нөхөн олговор'],
        ],
        'silver_director' => [
            'name' => ['ru' => 'Серебряный директор', 'kk' => 'Күміс директор', 'ky' => 'Күмүш директор', 'en' => 'Silver Director', 'mn' => 'Мөнгөн директор'],
            'reward' => ['ru' => 'Зарубежная поездка + 250 000 ₸, при отказе 750 000 ₸', 'kk' => 'Шетелдік сапар + 250 000 ₸, бас тартса 750 000 ₸ өтемақы', 'ky' => 'Чет өлкөгө сапар + 250 000 ₸, баш тартса 750 000 ₸ компенсация', 'en' => 'International trip + 250,000 ₸, 750,000 ₸ compensation if refused', 'mn' => 'Гадаад аялал + 250 000 ₸, татгалзвал 750 000 ₸ нөхөн олговор'],
        ],
        'gold_director' => [
            'name' => ['ru' => 'Золотой директор', 'kk' => 'Алтын директор', 'ky' => 'Алтын директор', 'en' => 'Gold Director', 'mn' => 'Алтан директор'],
            'reward' => ['ru' => '5 000 000 ₸ cash bonus', 'kk' => '5 000 000 ₸ ақшалай бонус', 'ky' => '5 000 000 ₸ акчалай бонус', 'en' => '5,000,000 ₸ cash bonus', 'mn' => '5 000 000 ₸ мөнгөн бонус'],
        ],
        'platinum_director' => [
            'name' => ['ru' => 'Платиновый директор', 'kk' => 'Платина директор', 'ky' => 'Платина директор', 'en' => 'Platinum Director', 'mn' => 'Платинум директор'],
            'reward' => ['ru' => '6 000 000 ₸ cash bonus', 'kk' => '6 000 000 ₸ ақшалай бонус', 'ky' => '6 000 000 ₸ акчалай бонус', 'en' => '6,000,000 ₸ cash bonus', 'mn' => '6 000 000 ₸ мөнгөн бонус'],
        ],
        'emerald_director' => [
            'name' => ['ru' => 'Изумрудный директор', 'kk' => 'Изумруд директор', 'ky' => 'Изумруд директор', 'en' => 'Emerald Director', 'mn' => 'Маргад директор'],
            'reward' => ['ru' => '10 000 000 ₸ auto bonus', 'kk' => '10 000 000 ₸ авто бонус', 'ky' => '10 000 000 ₸ авто бонус', 'en' => '10,000,000 ₸ auto bonus', 'mn' => '10 000 000 ₸ авто бонус'],
        ],
        'diamond_director' => [
            'name' => ['ru' => 'Бриллиантовый директор', 'kk' => 'Бриллиант директор', 'ky' => 'Бриллиант директор', 'en' => 'Diamond Director', 'mn' => 'Очир директор'],
            'reward' => ['ru' => '20 000 000 ₸ apartment bonus', 'kk' => '20 000 000 ₸ пәтер бонусы', 'ky' => '20 000 000 ₸ батир бонусу', 'en' => '20,000,000 ₸ apartment bonus', 'mn' => '20 000 000 ₸ байрны бонус'],
        ],
    ];
