...
class AdminPartnersApiTest extends TestCase
{
    ...
    public function test_admin_partners_list_start_package_assignment_keeps_balance_zero(): void
    {
    ...
    public function test_admin_partners_list_vip_package_assignment_keeps_balance_zero(): void
    {
    ...
    public function test_admin_partners_list_elite_package_assignment_keeps_balance_zero(): void
    {
    ...
    public function test_admin_partners_list_package_activity_amount_is_not_used_for_balance(): void
    {
        $payload = $this->assignPackageAndGetAdminPayload('START');
    ...
    public function test_admin_partners_summary_total_balance_excludes_package_activity_transaction(): void
    {
