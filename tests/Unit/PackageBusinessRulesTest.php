...
class PackageBusinessRulesTest extends TestCase
{
    ...
    public function test_package_matrix_matches_business_tz(): void
    {
        ...
        $this->assertPackage('START', '60000.00', '10.00', '7.00');
        $this->assertPackage('VIP', '180000.00', '10.00', '8.00');
        $this->assertPackage('ELITE', '300000.00', '10.00', '10.00');
    }
    ...
    private function assertPackage(string $code, string $price, string $referralPercent, string $binaryPercent): void
    {
