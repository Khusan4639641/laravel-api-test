...
class AdminPartnerDetailBalanceTest extends TestCase
{
    ...
    public function test_start_package_assignment_adds_activity_amount_to_display_balances(): void
    {
    ...
    public function test_vip_package_assignment_adds_activity_amount_to_display_balances(): void
    {
    ...
    public function test_elite_package_assignment_adds_activity_amount_to_display_balances(): void
    {
    ...
    public function test_package_price_is_not_used_as_pv_activity_amount_or_display_balance(): void
    {
    ...
    public function test_wallet_amount_is_added_to_package_activity_amount_for_display_balances(): void
    {
