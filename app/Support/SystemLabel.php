...
final class SystemLabel
{
    ...
    private const LABELS = [
        ...
        'transaction_types' => [
            ...
            'order_deposit_payment' => ['ru' => 'Оплата заказа: депозит', 'kz' => 'Тапсырыс төлемі: депозит', 'kg' => 'Заказ төлөмү: депозит', 'en' => 'Order payment: deposit', 'mn' => 'Захиалгын төлбөр: депозит'],
            'order_deposit_refund' => ['ru' => 'Возврат депозитной части заказа', 'kz' => 'Тапсырыстың депозит бөлігін қайтару', 'kg' => 'Заказдын депозит бөлүгүн кайтаруу', 'en' => 'Order deposit part refund', 'mn' => 'Захиалгын депозит хэсгийн буцаалт'],
