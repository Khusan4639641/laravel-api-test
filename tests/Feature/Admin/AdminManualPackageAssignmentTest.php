...
class AdminManualPackageAssignmentTest extends TestCase
{
    ...
    public function test_manual_package_assignment_records_package_transaction_without_crediting_buyer_balance(): void
    {
        $admin = User::factory()->create(['role' => User::ROLE_SUPER_ADMIN]);
    ...
    private function assertNoPackageActivityCredit(User $partner): void
    {
        $this->assertDatabaseMissing('wallet_transactions', [
            'user_id' => $partner->id,
            'type' => 'package_activity_credit',
