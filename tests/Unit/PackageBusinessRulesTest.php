...
class PackageBusinessRulesTest extends TestCase
{
    ...
    public function test_package_matrix_matches_business_tz(): void
    {
        ...
        $this->assertPackage('START', '60000.00', '100.00', '100.00', '50000.00', '10.00', '7.00');
        $this->assertPackage('VIP', '180000.00', '300.00', '300.00', '150000.00', '10.00', '8.00');
        $this->assertPackage('ELITE', '300000.00', '500.00', '200.00', '250000.00', '10.00', '10.00');
    }
    ...
    ): void
    {
        ...
        $this->assertSame($pvAmount, $package->volumeAmount());
